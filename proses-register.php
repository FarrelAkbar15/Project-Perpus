...
if (isset($_POST["register"])) {
    ...
    if ($query) {
        ...
        echo "<script> alert('Registrasi Terlebih Dahulu')</script>)";
    }
}
?>
            ...
            <div class="card-body">
                <form action="" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="iUsername" id="username" required>
                    </div>
                     <div class="mb-3">
                    ...
                    <!-- <div class="mb-3">
                        ...
                        <input type="password" class="form-control" name="iPassword" id="password" required>
                    </div>
                    <div class="mb-3">
                        <button type="submit" class="btn btn-primary w-100" name="register">Register!</button>
                        <p class="mt-3 text-center">
                    Sudah punya akun? Login <a href="form-login.php">di sini</a>
                        </p>
                    </div>
                </form>
            </div>
